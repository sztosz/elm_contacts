...
var _user$project$Messages$FetchContactListError = function (a) {
	return {ctor: 'FetchContactListError', _0: a};
};
var _user$project$Messages$FetchContactListSuccess = function (a) {
	return {ctor: 'FetchContactListSuccess', _0: a};
};
...
var _user$project$Commands$fetch = F3(
	function (socketUrl, page, search) {
		...
		var push = A2(
			_saschatimme$elm_phoenix$Phoenix_Push$onError,
			_user$project$Messages$FetchContactListError,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Push$onOk,
				_user$project$Messages$FetchContactListSuccess,
				A2(
					_saschatimme$elm_phoenix$Phoenix_Push$withPayload,
					payload,
					A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'contacts', 'contacts:fetch'))));
		return A2(_saschatimme$elm_phoenix$Phoenix$push, socketUrl, push);
	});
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('fa fa-map-maker'),
																		_1: {ctor: '[]'}
																	},
																	{ctor: '[]'}),
																_1: {
			...
			case 'FetchContactError':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							contact: _user$project$Model$Failure('Error while fetching contact')
						}),
					{ctor: '[]'});
			case 'Paginate':
				return A2(
...
var _user$project$View$notFoundView = A3(_user$project$Common_View$warningMessage, 'fa fa-meh-o fa-stack-x2', 'Page not found', _user$project$Common_View$backToHomeLink);
...
var _user$project$View$headerView = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Phonix & Elm'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
...
var _user$project$Subscriptions$contacts = _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
	_saschatimme$elm_phoenix$Phoenix_Channel$init('contacts'));
var _user$project$Subscriptions$socket = function (socketUrl) {
	return _saschatimme$elm_phoenix$Phoenix_Socket$init(socketUrl);
};
